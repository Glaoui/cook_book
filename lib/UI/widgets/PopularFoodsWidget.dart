                                     ...
                                     Stack(
                                       children: <Widget>[
                                         ...
                                         Align(
                                           ...
                                           child: Center(
                                               child: Image.network('http://192.168.43.198:3012/public/images/' +
                                                data[index].imageURL ,
                                                 width: 130,
                                                 height: 140,
                                               )),
                                     ...
                                     Row(
                                       ...
                                       children: <Widget>[
                                         Container(
                                           ...
                                           child: Text(data[index].name,     /** name*/
                                               style: TextStyle(
                                             ...
                                             Container(
                                               ...
                                               Row(
                                                 children: <Widget>[
                                                   ...
                                                   Text(data[index].calories.toString() + " Calories " , /***Calories***/
                                                   style: TextStyle(
                                                       color: Color(0xFF6e6e71),
                                                       fontSize: 10,
                                             ...
                                             Container(
                                               ...
                                               Row(
                                                 children: <Widget>[
                                                   ...
                                                   Text(data[index].servings.toString(), /***** Servings****/
                                                   style: TextStyle(
                                                       color: Color(0xFF6e6e71),
                                                       fontSize: 10,
                                                       fontWeight: FontWeight.w400)),
